            ...
            >
              ...
              {calc.bonusPercent > 0 && (
                <div className="flex items-center gap-2">
                  <span className="px-3 py-1.5 bg-[#d4a853] text-[#0d0b1a] text-xs font-bold rounded-full whitespace-nowrap">
                    +{formatNumber(calc.bonusShares)} Free Shares
                  </span>
                  <span className="px-2.5 py-1.5 bg-[#2a2640] text-[#d4a853] text-xs font-bold rounded-full border border-[#d4a853] whitespace-nowrap">
